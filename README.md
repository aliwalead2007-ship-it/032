...
- **الأولوية المعلّقة:** **إثبات التصدير على جهاز حقيقي** — تثبيت APK → فكرة عربية قصيرة → معالجة → تصدير → تشغيل الملف (تحقق: كابشن عربي، مدة، عمل بلا نت/بلا TTS). أي انهيار الآن يُسجَّل تلقائياً في `crash_logs/` وتظهره لوحة المطور بتشخيص عربي؛ والسبلاش الجديد يُتحقق بصرياً عند أول تشغيل؛ وقسم القرآن (Hub المصحف الذهبي) يُتحقق كما في `AGENTS.md` §4 — منها **النص العثماني الحقيقي** (أي سورة من «المصحف الشريف 📖» تُظهر الآيات بدل «النص غير متوفر») و**البحث النصي** («الكرسي» → آية 2:255 تفتح بتظليل ذهبي) و**التفسير الميسر المدمج** (تفسير أي آية، ومنها 2:255 و1:1 و114:6).
