...
public final class OutlinedButtonTokens {
    ...
    private static final float ContainerHeight = Dp.m6633constructorimpl((float) 40.0d);
    ...
    private static final float IconSize = Dp.m6633constructorimpl((float) 18.0d);
    ...
    public final float m3347getContainerHeightD9Ej5fM() {
    ...
    public final float m3349getOutlineWidthD9Ej5fM() {
        return OutlineWidth;
    }
